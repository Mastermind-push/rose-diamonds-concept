    ...
    <div className="client-drawer-layer" role="dialog" aria-modal="true" aria-label="Shopping bag">
      ...
      <aside className="client-drawer">
        ...
        {entries.length ? <>
          ...
          <footer className="client-bag-total"><div><span>Total</span><strong>${subtotal.toLocaleString("en-US")}</strong></div><p>Complimentary insured delivery, taxes and duties are included.</p><a className="button button-dark" href="/checkout">Checkout</a></footer>
