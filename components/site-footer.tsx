...
export default function SiteFooter() {
  return (
    <footer id="footer">
      ...
      <div className="footer-bottom"><nav className="footer-policy-links" aria-label="Legal policies"><Link href="/policies/privacy">Privacy Policy</Link><Link href="/policies/terms-of-service">Terms of Service</Link><Link href="/policies/ethical-sourcing">Ethical Sourcing</Link><Link href="/policies/modern-slavery">Modern Slavery</Link></nav><span className="footer-delivery">Complimentary insured delivery · Taxes included</span><span className="footer-copyright">© 2026 ROSÉ Diamonds Ltd.</span></div>
    </footer>
  );
}
